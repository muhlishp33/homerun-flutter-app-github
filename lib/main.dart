...
import 'package:appid/ui/insight/insight.dart';
import 'package:appid/ui/insight/insight_detail.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void handleDeepLink(RemoteMessage message) async {
    ...
    Helper(context: AppNavigatorService.navigatorKey.currentContext!).cekUri(link, pushToLog: true);
  }
  ...
  Route _generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      // insight
      case '/insightPage':
        return MaterialPageRoute(builder: (context) => const InsightPage());
      case '/insightDetailPage':
        return MaterialPageRoute(builder: (context) => InsightDetailPage(settings.arguments));
