...
class DetailVoucherBeli extends StatefulWidget {
  dynamic dataVoucher, type;
  DetailVoucherBeli({this.dataVoucher, this.type});
  @override
  State<DetailVoucherBeli> createState() => _DetailVoucherBeliState();
}

class _DetailVoucherBeliState extends State<DetailVoucherBeli> {
  dynamic profile;
  String namaProfile = "";
  String iplProfile = "";
  ...
  void initState() {
    ...
    if (widget.dataVoucher['status'] != 3) {
      setState(() {
        isRedeem = true;
      });
    }
            ...
            children: [
              AspectRatio(
                ...
                child: CachedNetworkImage(
                  imageUrl: '${widget.dataVoucher['image']}',
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          'Available until ${widget.dataVoucher['end_date']}',
                          style: TextStyle(
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          'Reedem at ${widget.dataVoucher['use_at_description']}',
                          style: TextStyle(
                              fontSize: 13, fontWeight: FontWeight.w600),
                        )
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Text('${widget.dataVoucher['need_point']}'),
                      ],
                    ),
                    SizedBox(
                      height: 24,
                    ...
                    Text('${widget.dataVoucher['description']}'),
                    SizedBox(
                      height: 15,
                    ),
                    SizedBox(
                    ...
                    Html(
                      data: widget.dataVoucher["term_and_condition"],
                      //Optional parameters:
                      style: {
                        "html": Style(
  ...
  Widget _buttonRedeem() {
    if (widget.dataVoucher['from_page'] == 'my_rewards') {
      ...
      bool isOnline = (widget.dataVoucher['type'] == "ONLINE") ? true : false;
      bool isImage = (widget.dataVoucher['type'] == "IMAGE") ? true : false;
      if (isOnline) {
      ...
      return InkWell(
        onTap: () async {
          if (!isOnline && !isImage) {
            final id = widget.dataVoucher['id'];
            final title = widget.dataVoucher['v_name'];
          ...
          if (isOnline) {
            return await Clipboard.setData(ClipboardData(
                    text: widget.dataVoucher['copy_voucher_code']))
                .then((value) {
          ...
          if (isImage) {
            ...
            return Helper(context: context)
                .viewPhoto(
                    url: widget.dataVoucher['image_voucher'],
  ...
  _claimVoucher() {
    var body = {"code": widget.dataVoucher['v_code']};
    //("profile = ${profile} ");
