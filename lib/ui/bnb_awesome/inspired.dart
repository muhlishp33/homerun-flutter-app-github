...
class _InspiredState extends State<Inspired> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    NotchSmoothness notchSmoothness = widget.chipStyle?.notchSmoothness ?? NotchSmoothness.sharpEdge;
        ...
        SizedBox(
          ...
          child: CustomPaint(
            painter: ConvexPainter(
              ...
              leftCornerRadius: widget.radius,
              rightCornerRadius: widget.radius,
            ),
          ),
        ),
